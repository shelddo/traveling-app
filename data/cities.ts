...
export const cities: City[] = [
  ...
  },
  {
    ...
    name: "São Paulo",
    country: "Brasil",
    coverImage: require("./images/sao-paulo.jpg"),
    description:
      "São Paulo, a maior cidade da América Latina, é um vibrante centro financeiro, cultural e gastronômico. Conhecida por sua diversidade, arranha-céus imponentes, museus de classe mundial e uma cena gastronômica que mistura influências de todo o mundo, a cidade oferece uma experiência urbana única e acolhedora.",
    categories: [categories[1], categories[4], categories[6], categories[9], categories[5]], // Urbano, Cultura, História, Gastronomia, Compras
    touristAttractions: [
      {
        id: "sp1",
        name: "Parque Ibirapuera",
        description:
          "O maior e mais famoso parque urbano de São Paulo, com museus, lagos, trilhas e áreas de lazer, sendo o pulmão da cidade.",
        cityId: "sao-paulo",
      },
      {
        id: "sp2",
        ...
        description:
          "Uma das avenidas mais importantes da cidade, repleta de museus, centros culturais, restaurantes e uma vista impressionante do horizonte paulistano.",
        cityId: "sao-paulo",
      },
      {
        id: "sp3",
        ...
        description:
          "Um marco gastronômico da cidade, famoso por sua variedade de produtos frescos, restaurantes e o famoso sanduíche de mortadela.",
        cityId: "sao-paulo",
      },
      {
        id: "sp4",
        ...
        description:
          "Um dos museus de arte mais importantes da América Latina, com uma coleção vasta de obras europeias e brasileiras, abrigado em um edifício icônico.",
        cityId: "sao-paulo",
      },
    ],
    relatedCitiesIds: ["new-york", "barcelona", "ciudad-de-mexico", "melbourne"], // Urban, Culture, History, Gastronomy
    location: {
      latitude: -23.5505,
      longitude: -46.6333,
    },
